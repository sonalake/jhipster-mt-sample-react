    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="sampleMultitenancyAppReactApp.company.home.createOrEditLabel">
              <Translate contentKey="sampleMultitenancyAppReactApp.company.home.createOrEditLabel">Create or edit a Company</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
